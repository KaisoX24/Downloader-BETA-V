...
# Button images
button_image_data=Image.open(resource_path(r'assets\\frame0\\button_1.png'))
button_image_1= ctk.CTkImage(button_image_data,size=(205,55))
button_hover_1_data = Image.open(resource_path(r"assets\\frame0\\button_hover_1.png"))
button_image_hover_1= ctk.CTkImage(button_hover_1_data,size=(205,55))
